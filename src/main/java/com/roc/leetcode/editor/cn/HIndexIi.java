...
public class HIndexIi {
    public static void main(String[] args) {
        ...
        System.out.println(solution.hIndex(new int[]{5, 5, 5}));
    }
    ...
    class Solution {
        public int hIndex(int[] citations) {
            ...
            while (left <= right) {
                ...
                if (mid == 0 && citations[mid] < res) {
                    left = mid + 1;
                } else if (mid == 0 && citations[mid] >= res) {
                    break;
                } else if (citations[mid] >= res && citations[mid - 1] < res + 1) {
                    break;
                } else if (citations[mid] >= res && citations[mid - 1] >= res + 1) {
                    right = mid - 1;
                } else if (citations[mid] < res) {
                    left = mid + 1;
                }
            }
